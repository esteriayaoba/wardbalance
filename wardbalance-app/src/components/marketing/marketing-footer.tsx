        ...
        <div className="grid md:grid-cols-4 gap-8 md:gap-12 mb-12">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <p className="text-body-small text-on-surface-variant">
              Questions?{" "}
              <a
                href="mailto:hello@wardbalance.com.ng"
            ...
            <div className="flex items-center gap-4 pt-1">
              <a
                href="https://twitter.com/wardbalance"
                target="_blank"
              ...
              <a
                href="https://linkedin.com/company/wardbalance"
                target="_blank"
                rel="noopener noreferrer"
            ...
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  className="text-body-medium hover:underline text-on-surface-variant cursor-pointer"
                >
                  How It Works
                </a>
              </li>
