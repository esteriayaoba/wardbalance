...
import { Loader2, Coins, Banknote, CreditCard, TrendingUp, AlertTriangle, ArrowRight, Activity, FileText, CheckCircle2, UserPlus, AlertCircle, RefreshCw, Calendar, Clock, Rocket, MapPin, Building2, Sparkles } from "lucide-react";
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-neutral-200/80 pb-5">
          <div className="space-y-2">
            ...
            <p className="text-body-medium text-neutral-500 leading-relaxed">
        ...
        <div className="bg-white border border-neutral-200 rounded-xl p-6 lg:p-8 shadow-sm">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
            ...
            <div className="lg:col-span-7 flex flex-col justify-between space-y-6">
              <div className="space-y-3">
                <div className="flex items-center gap-2.5">
                  <span className="px-2.5 py-1 rounded bg-primary/10 text-primary text-label-small uppercase tracking-wider font-bold">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-body-medium text-neutral-500 max-w-xl leading-relaxed">
              ...
              <div className="space-y-3 bg-neutral-50/80 p-4 rounded-xl border border-neutral-200/80">
                ...
                <div className="grid grid-cols-3 gap-2.5 pt-1">
                  {[
                    ...
                    return (
                      <div
                        key={phase.label}
                        className={`px-2.5 py-2 rounded-lg text-xs font-bold text-center transition-all flex items-center justify-center gap-1 ${
                          isDone
            ...
            <div className="lg:col-span-5 bg-gradient-to-br from-primary-50/70 via-white to-primary-50/30 p-6 rounded-xl border border-primary/20 shadow-2xs flex flex-col justify-between gap-5">
              <div className="space-y-4">
                <div className="flex items-center justify-between gap-2 border-b border-primary/10 pb-3">
                  <span className="inline-flex items-center gap-1.5 text-xs font-bold text-primary tracking-wide uppercase">
                    <Sparkles className="w-3.5 h-3.5 text-primary shrink-0" />
                    Recommended Next Step
                  </span>
                  <span className="px-2.5 py-0.5 rounded-full bg-white border border-primary/20 text-primary-700 text-[11px] font-semibold shadow-2xs">
                    {estTime}
                  </span>
                </div>
                ...
                <div className="flex items-start gap-3.5">
                  ...
                  <div className="space-y-1">
                    <h4 className="text-title-small text-neutral-950 font-bold leading-snug">
                      {nextActionTitle}
                    </h4>
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 opacity-60 pointer-events-none select-none">
            ...
            <DashboardStatCard label="Collected Revenue" value={0} icon={Banknote} subtitle="Total verified manual payments" valueColor="green" />
  ...
  return (
    <div className="space-y-6">
      ...
      <div id="dashboard-kpi-cards" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <DashboardStatCard label="Collected Revenue" value={stats?.collectedRevenue} icon={Banknote} subtitle="Total verified manual payments" valueColor="green" href="/admin/payments" />
