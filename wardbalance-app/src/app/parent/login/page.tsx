            ...
            <form onSubmit={handleVerifyOtp} className="space-y-5">
              ...
              {otpTimer <= 0 && (
                <button type="button" onClick={handleResendOtp} disabled={submitting}
                  className="w-full flex items-center justify-center gap-2 px-4 py-2 min-h-[44px] border border-primary-200 text-primary hover:bg-primary-50 rounded-lg font-bold text-body-small transition disabled:opacity-50 cursor-pointer">
